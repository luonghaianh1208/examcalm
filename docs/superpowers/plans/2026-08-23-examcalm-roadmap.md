...
|---|---|---|
| 1 | Mọi lời gọi Firestore/callable từ client phải `await ensureAuthReady()` trước | Phát hiện lại **5 lần** (moods, attempts, favorites, admin-resources, functions-client) |
