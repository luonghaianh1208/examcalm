...
// Placeholder RÕ RÀNG là placeholder — không bịa tên trường trông như dữ liệu thật.
const UNSET_SCHOOL = "(chưa cập nhật trường)";
...
export async function ensureUserProfile(
  ...
  try {
    ...
    await ref.create({
      ...
      // Không có nguồn dữ liệu thật nào ở bước đăng nhập cho khối lớp — chọn tạm
      // "10", chờ người dùng tự sửa (chưa có UI sửa hồ sơ — ngoài phạm vi vá lỗi này).
      gradeLevel: "10",
      school: UNSET_SCHOOL,
      examGoals: [],
